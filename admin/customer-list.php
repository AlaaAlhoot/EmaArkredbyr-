                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td> <a href="add-customer-services.php?addid=<?php echo $row['ID']; ?>" class="btn btn-primary">Assign Services</a>
                                                ...
                                                <!-- <a id="sendmsg" class="btn btn-primary" href="#">message</a> -->

                                                <a href="customer-list.php?delid=<?php echo $row['ID']; ?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?')"> <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                        <path d="M3 6h18"></path>
