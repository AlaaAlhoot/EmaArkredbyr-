...
$cid = $_GET['lid'];
    ...
    while ($row = mysqli_fetch_array($ret)) {
        ...
        ?>
                                ...
                                <div class="form-group"> <label for="exampleInputPassword1">Old Image</label> <img
                                        loading="lazy" src="images/<?php echo $row['Image'] ?>" width="120">
                                </div>
                                <div class="form-group"> <label for="exampleInputEmail1">New Images</label> <input
