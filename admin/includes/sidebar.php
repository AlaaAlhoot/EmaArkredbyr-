      ...
      <div class="navbar-collapse">
          <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
              <ul class="nav" id="side-menu">
                  ...
                  <li>
                      <a href="todo.php"><i style="color:#fff;" class="fa fa-tasks nav_icon"></i>To Do Tasks</a>
                  </li>
                  ...
                  <li>
                      <a href="readenq.php"><i class="fa fa-user  nav_icon"></i>Users<span class="fa arrow"></span></a>
                      <ul class="nav nav-second-level collapse">
                          <li><a href="readenq.php">Accepted</a></li>
                          <li><a href="unreadenq.php">Awaiting acceptance</a></li>
                          <li><a href="useruplod.php">Uplode File</a></li>
                  ...
                  <li>
                      <a href="readenq.php"><i class="fa fa-file-text nav_icon"></i>Bills<span class="fa arrow"></span></a>
                      <ul class="nav nav-second-level collapse">

                          <li>
                              <a href="customer-list.php" class="chart-nav"><i class="fa fa-plus nav_icon"></i>Add Bill
                              </a>
                          </li>
                          <li>
                  ...
                  <li>
                      <a href="search-appointment.php" class="chart-nav"><i class="fa fa-search nav_icon"></i>Search
                          Appointment</a>
                  </li>
                  <li>
                      <a href="search-invoices.php" class="chart-nav"><i class="fa fa-search nav_icon"></i>Search
                          Invoice</a>
                  </li>
