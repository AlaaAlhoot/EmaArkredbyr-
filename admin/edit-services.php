                                ...
                                <form method="post">
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group"> <label for="exampleInputEmail1">Service Description</label>
                                            <textarea type="text" class="form-control" id="sername" name="serdesc" placeholder="Service Name" value="" required="true"><?php echo $row['ServiceDescription']; ?></textarea>
                                        </div>
                                        ...
                                        <div class="form-group"> <label for="exampleInputPassword1">Image</label> <img loading="lazy" src="images/<?php echo $row['Image'] ?>" width="120">
