    ...
    <?php include_once "includes/headerlogin.php"; ?>
        ...
        <div class="app-content">
          <div class="app-content-header">
            <p class="app-content-headerText">File View<br><br>Welcome | <span style="color: red;"><?php echo $row['FirstName']; ?></span></p>
  ...
  <table class="products-table">
    ...
    <tbody>
      <?php
       ...
       $query = mysqli_query($con, "select * from tbluseruplod where userid='$userid' ORDER BY tbluseruplod.RegDate DESC");
    if (!$query) {
        ...
        while ($row = mysqli_fetch_array($query)) {
          ...
          <tr>
            ...
            <td><?php echo $row["RegDate"]; ?></td>
             <td>
              <button class="btn btn-primary"><a href="admin/uploaduser/<?php echo $row['fileuplod']; ?>"target="_blank"class="btn btn-primary">View</a></button></td>
...
document.getElementById("fileview").classList.toggle("active");
